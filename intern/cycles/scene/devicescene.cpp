...
DeviceScene::DeviceScene(Device *device)
    : bvh_nodes(device, "bvh_nodes", MEM_GLOBAL),
      ...
      pixel_displacement_info(device, "pixel_displacement_info", MEM_GLOBAL),
      pixel_displacement_offset(device, "pixel_displacement_offset", MEM_GLOBAL),
      pixel_displacement_data(device, "pixel_displacement_data", MEM_GLOBAL),
      pixel_displacement_bvh_offset(device, "pixel_displacement_bvh_offset", MEM_GLOBAL),
      pixel_displacement_bvh_nodes(device, "pixel_displacement_bvh_nodes", MEM_GLOBAL),
